...
@section('content') 
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/01-10-2018/toys_shop-demo_Free/695002674/web/product.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Aug 2019 19:37:05 GMT -->
...
<!-- deals -->
                        ...
                        <div class="product-toys-info">
                           <div class="men-pro-item">
                              <div class="men-thumb-item">
                                 <img src="{{ asset('product_images/'.$p["photo"][0]->url)}}" width="200" class="img-thumbnail img-fluid" alt="">
      ...
      <script type="text/javascript" src="public/product.js"></script>
      <!-- //bootstrap working-->      <!-- //OnScroll-Number-Increase-JavaScript -->
   </body>

<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/01-10-2018/toys_shop-demo_Free/695002674/web/product.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Aug 2019 19:37:07 GMT -->
@endsection
